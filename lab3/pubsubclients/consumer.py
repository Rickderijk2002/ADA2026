...
if __name__ == '__main__':
    ...
    create_subscription("ada2026-486312", "diabetes_res", "diabetes_res_sub")
    pull_message(project="ada2026-486312", subscription="diabetes_res_sub")  # replace your project id
